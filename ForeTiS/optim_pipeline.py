...
def run(data_dir: str, save_dir: str = None, datasplit: str = 'timeseries-cv', test_set_size_percentage=None,
        val_set_size_percentage: int = 20, n_splits: int = 4, test_year: int = None, imputation_method: str = 'None',
        windowsize_current_statistics: int = 4, windowsize_lagged_statistics: int = 4, models: list = None,
        target_column: str = None, n_trials: int = 100, pca_transform: bool =False, save_final_model: bool = False,
        periodical_refit_cycles: list = None, refit_drops: int = 0, data: str = None, config_file: str = None,
        refit_window: int = 5, intermediate_results_interval: int = None, batch_size: int = 32, n_epochs: int = None,
        event_lags: int = None, optimize_featureset: bool = None, scale_thr: float = None, scale_seasons: int = None,
    ...
    datasets = base_dataset.Dataset(data_dir=data_dir, data=data, config_file=config_file, event_lags=event_lags,
                                    ...
                                    imputation_method=imputation_method, config=config, test_year=test_year)
